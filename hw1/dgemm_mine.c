...
#define L2_BLOCK_SIZE 192 // (KERNEL_SIZE_ALIGNED(L2_CACHE_SIZE, L2_CACHE_UTILIZATION))
#endif

#ifndef L3_BLOCK_SIZE
#define L3_BLOCK_SIZE 192 // (KERNEL_SIZE_ALIGNED(L3_CACHE_SIZE, L3_CACHE_UTILIZATION))
#endif
